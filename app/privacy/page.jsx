                        ...
                        <div className="u-align-center u-container-style u-group u-group-1">
                            <div className="u-container-layout u-valign-middle">
                                ...
                                <p className="u-text u-text-2" style={{ fontFamily: 'Frank Ruhl Libre, "PT Serif", "Noto Serif", "Noto Serif JP", "Noto Serif KR", "Noto Serif SC", "Noto Serif TC", ui-serif, Georgia, Cambria, Times New Roman, Times, serif', fontSize: "1.2rem", lineHeight: "2rem", fontWeight: "400" }}>
                                    ...
                                    <br/>We collect personal information that you voluntarily provide to us when ordering on the website ,subscribing to our newsletter, or contacting us for customer support. This may include your name, email address, phone number  and any other details necessary to fulfill your requests.

                                    <br/><br/>Data Protection

                                    <br/>Donishka employs robust security measures to protect your personal information from unauthorized access, alteration, disclosure, or destruction. We use encryption technologies and follow best practices to ensure your data is safe.

                                    <br/><br/>Use of Information

                                    <br/>The information we collect is used to provide and improve our services and enhance customer service.

                                    <br/><br/>Sharing of Information

                                    <br/>We do not sell, trade, or otherwise transfer your personal information to outside parties.

  
                                    <br/><br/>Contact Us

                                    <br/>If you have any questions about this Privacy Policy or our data practices, please <a href="contact">contact us</a>.
                                </p>
